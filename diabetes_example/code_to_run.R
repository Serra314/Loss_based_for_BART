...
# load the results
load('results/DIAB_list_models_ch_20_1to5.Rds')
load('results/DIAB_list_models_ch_20_6to10.Rds')
load('results/DIAB_list_models_lb_20_chain1to5.Rds')
load('results/DIAB_list_models_lb_20_chain6to10.Rds')

load('results/DIAB_list_models_lb_10.Rds')
load('results/DIAB_list_models_ch_10.Rds')



#####################################
# Number of terminal nodes analysis #
#####################################
...
# plot boxplot of numbert of terminal nodes boxplots per tree for m = 10
...
## likelihood - LB
load('results/list_pred_lb_20_1to5.Rds')
load('results/list_pred_lb_20_6to10.Rds')
...
## comparison LB vs CH
load('results/result_ch_20trees.Rds')
load('results/result_df_20trees.Rds')
loglik_lb_20chain.df$max_nn <- NULL
loglik_lb_20chain.df$q0.05_nn <- NULL
loglik_lb_20chain.df$q0.95_nn <- NULL
...
# Missing rate vs log-likelihood colored by average number of terminal nodes
...
## 10 trees analysis
load('results/list_pred_lb_10_10chain.Rds')
...
load('results/list_pred_ch_10_10chain.Rds')
...
nterm_sum_lb_20$accuracy <- aggregate(loglik_lb_20chain.df$acc, list(iter = loglik_lb_20chain.df$iter), mean)[,2]
...
nterm_sum_ch_20$accuracy <- aggregate(loglik_ch_20chain.df$acc, list(iter = loglik_ch_20chain.df$iter), mean)[,2]
...
###############################################
# Supplementary material Appendix I FIGURE 11 #
###############################################
...
###############################################
# Supplementary material Appendix I FIGURE 12 #
###############################################
